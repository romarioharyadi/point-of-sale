                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            <div class="table-responsive">
                                <table id="tableDataStokMasuk" class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="supplier" id="supplier" class="form-control supplier" style="width:100%;">
...
@section('script-down')
  @include('admin.master-data.stok-masuk.script')
@endsection