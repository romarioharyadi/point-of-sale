                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            <div class="table-responsive">
                                <table id="tableDataUnit" class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label style="font-size: 14px; font-weight: 600;">Unit Produk</label>
                        <input type="text" name="unit" class="form-control unit" id="unit" placeholder="Input Nama Unit">
                    </div>
                </div>
...
@section('script-down')
  @include('admin.master-data.unit.script')
@endsection